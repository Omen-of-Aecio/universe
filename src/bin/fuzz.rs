...
fn main() {
    ...
    loop {
        ...
        fuzz!(|data: &[u8]| {
            ...
            vertices.push(Vec2::new(bytes_to_f32(&data[10..14]), bytes_to_f32(&data[14..18])));
            vertices.push(Vec2::new(bytes_to_f32(&data[18..22]), bytes_to_f32(&data[22..26])));
            vertices.push(Vec2::new(bytes_to_f32(&data[26..30]), bytes_to_f32(&data[30..34])));
            vertices.push(Vec2::new(bytes_to_f32(&data[34..38]), bytes_to_f32(&data[38..42])));

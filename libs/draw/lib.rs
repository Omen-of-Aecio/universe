...
impl Draw {
    pub fn new(surface: &mut back::Surface) -> Self {
        ...
        // Step 4: Describe the variables into the pipeline
        ...
        // Step 6: Upload an image to the GPU
        ...
        // Step 7: Bind the buffer to an image on the device
                ...
                let (vs_entry, fs_entry) = (
                    pso::EntryPoint {
                        ...
                        specialization: pso::Specialization {
                            ...
                            data: unsafe { std::mem::transmute::<&f32, &[u8; 4]>(&0.3f32) },
                        },
                    },
                    pso::EntryPoint {
                        entry: ENTRY_NAME,
